...
author: Luca Baggi
date: '2021-01-28'
slug: dealing-with-implicitly-missing-data
categories:
tags:
  - covid19
  - wrangling
...
```{r}
vaccinations %>%
  expand(data, area, fornitore, fascia_anagrafica) %>% head()
```
